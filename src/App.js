        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="https://melbetaffiliates.com/" target="_blank" rel="noopener noreferrer" className="rounded-xl bg-black text-amber-400 hover:text-white px-5 py-3 font-semibold shadow">Go to official signup page</a>
              <button onClick={() => scrollTo('how')} className="rounded-xl border border-zinc-300 px-5 py-3 font-semibold hover:border-zinc-400">See the steps</button>
            </div>
          </div>
